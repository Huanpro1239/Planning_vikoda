"""Backward-compatible CLI for NVL stock synchronization.

Canonical implementation lives under the nvl package. Existing workflows and
external callers may keep using sync_nvl_stock.py during the migration window.
"""
